...
export const RPP_Info = {
  objective_long_names: [
    ...
    "Dissolved oxygen concentration at the munpath.icipality border ",
...
export async function get_solutions() {
  let reference_points = [
    [6.34, 3.44487179, 7.14, -3.2],
    [
      6.2406340010486, 3.451202476881564, 5.167433722087412, -5.902773320544301
    ],
    [
      5.7597554210153, 2.8720415929145733, 6.8867202610884535,
      -4.026246378519005e-7,
    ],
  ];
