export const RPP_Info = {
  objective_long_names: [
    "Dissolved oxygen concentration in the city",
    "Dissolved oxygen concentration at the municipality border ",
    "Percent return on investment at the fishery",
    "Addition to the city tax ",
    "(BOD) removed from the water close to the ideal value",
  ],
  objective_short_names: ["WQFish", "WQCity", "ROI", "CityTax", "Plant"],
  is_maximized: [true, true, true, true, true],
  lower_bounds: [5.23, 2.9, 0.32, -0.9, 0.013],
...
const Solution2 = {
  iteration: 0,
  index: 1,
  objective_values: [5.882, 3.01, 6.64, -0.825, 0.148],
  decision_variables: [0.7, 0.1],
};
const Solution3 = {
  iteration: 0,
  index: 2,
  objective_values: [6.006, 2.905, 6.249, -0.14, 0.203],
  decision_variables: [1.3, 1.1],
};
const Solution4 = {
  iteration: 0,
  index: 3,
  objective_values: [6.163, 2.96, 5.243, -0.422, 0.2772],
...
const Solution7 = {
  iteration: 1,
  index: 6,
  objective_values: [5.788, 2.9, 6.835, -0.141, 0.182],
...
const Iteration2 = {
  solutions: [Solution5, Solution6, Solution7, Solution8],
  reference_point: [5.9, 2.94, 5.72, -0.4, 0.2],
};

const Iteration3 = {
  solutions: [Solution9, Solution10, Solution11, Solution12],
  reference_point: [5.826, 2.989, 6.765, -0.682, 0.123],
};

export const solution_process = [Iteration1, Iteration2, Iteration3];
